...
let frutas: string[] = ['Banana', 'Maçã', 'Uva', 'Pera', 'Melancia'];
console.log(frutas[2]);

// ==> Exemplo 02 - Array Object (Objeto Array):

let frutas1: Array<string> = ['Banana', 'Maçã', 'Uva', 'Pera', 'Melancia'];
...
let listaNumeros2: Array<number> = [...listaNumeros, 6, 7, 8, 9, 10];

console.log(listaNumeros2);

// ==> Exemplo 06 - Exemplo de Array com laço de iteração

let linguagensArray:string[] = ['JavaScript', 'TypeScript', 'Python', 'Java'];
